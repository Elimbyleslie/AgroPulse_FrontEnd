...
const LotDashboard = ({ farmId }: { farmId: number }) => {
  ...
  const lots = Array.isArray(entities) ? entities : [];
  ...
  const getAgeGroupLabel = (ageGroup: string) => {
    const labels: Record<string, string> = {
      young: 'Jeune', adult: 'Adulte', breeding: 'Reproduction',
      fattening: 'Engraissement', mixed: 'Mixte'
    };
                  ...
                  <div className="space-y-2.5 text-sm">
                    <div className="flex items-center gap-2 text-gray-600">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-medium text-gray-900 truncate">{lot.species?.name || 'N/A'}</p>
                        <p className="text-xs text-gray-500 truncate">{lot.breed?.name || 'Race non spécifiée'}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-gray-600">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-medium text-gray-900 truncate">{lot.barn?.name || `#${lot.barnId}`}</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900 text-xs">{getAgeGroupLabel(lot.ageGroup)}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-gray-600 pt-2 border-t border-gray-100">
                      ...
                      <span className="text-xs">Entrée le {formatDate(lot.entryDate)}</span>
                    </div>
                  </div>
