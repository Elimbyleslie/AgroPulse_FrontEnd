...
import { fetchAnimalHistory } from "../../../store/AnimalHistory/action";
import { resetHistory } from "../../../store/AnimalHistory/slice";
...
const AnimalHistory: React.FC = () => {
  ...
  const { events, loading } = useAppSelector((state) => state.animalHistory);
  ...
  useEffect(() => {
    ...
    return () => { dispatch(resetHistory()); }; // Nettoyage au démontage
  }, [dispatch, id]);
